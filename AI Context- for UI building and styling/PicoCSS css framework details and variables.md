Title: CSS variables • Pico CSS

URL Source: https://picocss.com/docs/css-variables

Markdown Content:
CSS variables • Pico CSS
===============
[Skip to content](https://picocss.com/docs/css-variables#content)

[](https://picocss.com/)
*   
v2.1.1
    *   [v2.1.1](https://picocss.com/docs)
    *   [v1.5.13](https://picocss.com/docs/v1/)
...
Content
*   [Introduction](https://picocss.com/docs/css-variables)
*   [Example](https://picocss.com/docs/css-variables#example)
*   [Color schemes](https://picocss.com/docs/css-variables#css-variables-for-color-schemes)
*   [All CSS variables](https://picocss.com/docs/css-variables#all-css-variables)
...
All CSS variables are prefixed with `pico-` to avoid collisions with other CSS frameworks or your own vars. You can remove or customize this prefix by recompiling the CSS files with [SASS](https://picocss.com/docs/sass).
...
Get ready to dance and sing your heart out at our Music Fest Mania. Join the crowd, jam to your favorite band, and discover new artists.

Let’s rock out![](https://picocss.com/docs/css-variables)
```html
<style>
  :root {
...
CSS variables for color schemes[#](https://picocss.com/docs/css-variables#css-variables-for-color-schemes)
----------------------------------------------------------------------------------------------------------
...
The first inclusion is in the `@media`query that checks if the user has dark mode enabled through their device settings with
```
prefers-color-scheme:
            dark
```
. In this case, the dark mode styling is applied to the `:root` element if there is no explicit `data-theme` attribute set.
...
There are two categories of CSS variables:

1.   **Style variables**, which do not depend on the color scheme,
2.   **Color variables**, which depend on the color scheme.
...
[Edit this page on GitHub](https://github.com/picocss/picocss.com/blob/main/app/routes/docs.css-variables.jsx)

*   **About**
*   [What’s new?](https://picocss.com/docs/v2)
*   [Brand](https://picocss.com/docs/brand)
*   [Mission](https://picocss.com/docs/mission)
*   [Usage scenarios](https://picocss.com/docs/usage-scenarios)
...
*   **Docs**
*   [Quick start](https://picocss.com/docs)
*   [Version picker](https://picocss.com/docs/version-picker)
*   [Class-less version](https://picocss.com/docs/classless)
*   [Form elements](https://picocss.com/docs/forms)
...
*   [All](https://picocss.com/examples)
