...
return details({name: "record-container", class: "incidentrecord", open: true},
    summary({class: "rec-title", style: `height: 50px; border-color: transparent; display: flex; justify-content: space-between; align-items: center;`},
      div({style: "display: flex; justify-content: space-between; align-items: center; white-space: nowrap; width: 100%;"},
        ...
        span({style: "font-size: 20px; font-weight: bold;"}, `${"4"}: ${makeModelVal.val} - ${plateNumVal.val}`),
        img({ src: "../images/car.jpg", style: "height: 40px; width: 40px; border-radius: 4px" })
      ),
    ),
    article({class: "rec-content"},
